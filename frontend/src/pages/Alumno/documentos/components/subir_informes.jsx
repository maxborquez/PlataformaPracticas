...
const SubirInformes = ({ id }) => {
    ...
    const onSubmit = async (e) => {
        ...
        formData.append("tipo_documento", "Evaluación");
            ...
            <Card sx={{ width: "90%", margin: "0px auto", padding: "15px" }}>
                <Box>
                    <form onSubmit={onSubmit} style={{ width: "90%", margin: "0px auto", display: "flex", flexDirection: "column" }}>
                        <Typography variant="h5" sx={{ textAlign: "center", marginTop: "5px", marginBottom: "10px", display:"flex",justifyContent:"center",alignItems:"center" }}>Documentos Evaluaciones <CopyAllOutlined/> </Typography>
                        <Grid container sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
                            <Grid item xs={11} xl={7} lg={10} md={6} sm={10}>
                                {/* Agregar la referencia al input de archivo */}
                                <TextField ref={inputFileRef} required type="file" onChange={handleArchivoSeleccionado} fullWidth />
