    ...
    if(status === "success" && !data.empresas){
        return (
            <TableContainer component={Paper} sx={{ width: "90%", margin: "0px auto", marginTop: "10px" }}>
                ...
                <Alert severity="error" sx={{ margin: "10px auto", width: "20%", textAlign: "center" }}>No hay empresas registradas</Alert>
            </TableContainer>
        );
    }
    ...
    if(status === "loading"){
        return (
            <TableContainer component={Paper} sx={{ width: "100%" }}>
                ...
                <Grid sx={{ margin: "0px auto", height: "100px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", fontFamily: "arial" }}>
                    Cargando datos.....
                    <CircularProgress />
                </Grid>
            </TableContainer>
