...
const ContadorPractica1  = ({anio,periodo_academico})=>{

    const listado_alumnos = useQuery("practica1", async ()=>{
        const response = await clienteAxios.post("/inscripcion/listadopractica1",{
            anio:Number(anio),
...
export default ContadorPractica1;