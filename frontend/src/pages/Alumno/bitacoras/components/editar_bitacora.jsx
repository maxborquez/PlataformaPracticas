...
const EditarBitacora = () => {
  ...
  const handleSave = () => {
    ...
    if (horaInicio !== initialData.hora_inicio)
      updatedFields.hora_inicio = horaInicio;
    if (horaFin !== initialData.hora_fin) updatedFields.hora_fin = horaFin;
    if (tipoBitacora !== initialData.id_tipo_bitacora)
      updatedFields.id_tipo_bitacora = tipoBitacora; // Use the correct field name
                ...
                <Paper sx={{ padding: "16px" }}>
                  ...
                  <FormControl fullWidth sx={{ marginBottom: "16px" }}>
                    ...
                    >
                      ...
                      <MenuItem value={5}>
                        Aplicaciones pars HW Industrial y Laboratorio
                      </MenuItem>
