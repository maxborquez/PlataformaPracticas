...
routerBitacoras.post(
  ...
  [
    ...
    body("fecha_creacion")
      .notEmpty()
      .withMessage("El campo fecha creacion es requerido")
      .isDate()
      .withMessage("El campo fecha_creacion debe ser un date"),
    body("hora_inicio")
      .notEmpty()
      .withMessage("El campo hora inicio es requerido"),
    body("hora_fin").notEmpty().withMessage("El campo hora fin es requerido"),
    body("id_estado_bitacora")
      .notEmpty()
      .withMessage("El campo id estado bitacora es requerido")
      .isInt()
      .withMessage("El campo debe ser un entero"),
    body("id_inscripcion_practica")
      .notEmpty()
      .withMessage("El campo id inscripcion practica es requerido")
      .isInt()
      .withMessage("El campo debe ser un entero"),
    body("id_usuario")
      .notEmpty()
      .withMessage("El campo id_usuario es requerido")
      .isInt()
      .withMessage("El campo debe ser un entero"),
  ],
